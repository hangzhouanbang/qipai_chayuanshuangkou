package com.anbang.qipai.chayuanshuangkou;
...
import com.anbang.qipai.chayuanshuangkou.conf.FilePathConfig;
import com.anbang.qipai.chayuanshuangkou.cqrs.c.reppository.SingletonEntityFactoryImpl;
import com.anbang.qipai.chayuanshuangkou.cqrs.c.service.disruptor.CoreSnapshotFactory;
import com.anbang.qipai.chayuanshuangkou.cqrs.c.service.disruptor.ProcessCoreCommandEventHandler;
import com.anbang.qipai.chayuanshuangkou.cqrs.c.service.disruptor.SnapshotJsonUtil;
import com.anbang.qipai.chayuanshuangkou.init.InitProcessor;
import com.dml.users.UserSessionsManager;
import com.highto.framework.ddd.SingletonEntityRepository;

@SpringBootApplication
@EnableScheduling
public class QipaiChayuanshuangkouApplication {
	...
	public static void main(String[] args) {
		SpringApplication.run(QipaiChayuanshuangkouApplication.class, args);
	}
}
