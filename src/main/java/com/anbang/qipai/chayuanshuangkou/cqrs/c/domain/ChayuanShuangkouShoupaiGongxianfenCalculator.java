 ...
 *
 */
public class ChayuanShuangkouShoupaiGongxianfenCalculator {

	/**
	 * 计算玩家总贡献分
	 */
	public static ChayuanShuangkouGongxianFen calculateTotalGongxianfenWithShouPaiForPlayer(String playerId, Ju ju,
	...
	private static ChayuanShuangkouGongxianFen calculateBestGongxianfen(int[] dianshuCountArray, BianXingWanFa bx,
		...
		ChayuanShuangkouGongxianFen bestGongxianfen = new ChayuanShuangkouGongxianFen();
		bestGongxianfen.calculateXianshu(gxjb);
	...
	private static void calculateGongxianfen(int[] dianshuCountArray, BianXingWanFa bx, int[] xianshuArray,
			List<ZhadanDianShuZu> zhadanDianShuZuList, ChayuanShuangkouGongxianFen bestGongxianfen, boolean gxjb) {
